...
namespace AutoPatterns.Tests
{
    internal static class Utils
    {
        ...
        private static readonly Regex _generatorPattern = new(@"\s* \[ System \. CodeDom \. Compiler \. GeneratedCode .*? \]", REGEX_OPTIONS);
        private static readonly Regex _compilerGeneratedPattern = new(@"\s* \[ System \. Runtime \. CompilerServices \. CompilerGenerated .*? \]", REGEX_OPTIONS);
        ...
        public static string ScrubGeneratorComments(string text)
        {
            ...
            text = _compilerGeneratedPattern.Replace(text, "");
